...
- Show the active image folder in the header and open it in the system file manager.
...
- Set NativePHP application metadata to Обладнання та дані by homeandriy.
