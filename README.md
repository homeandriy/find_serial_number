...
- Інтерфейс українською, англійською та польською мовами; вибір зберігається локально.
- Локалізовані назви вкладок у заголовку вікна Windows, меню Help, місяці у статистиці та перший запуск.
